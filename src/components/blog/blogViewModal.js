...
export default function BlogFormModal({ blog, onClose, onSubmit, title }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 overflow-y-auto backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full mx-4 my-8 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8">
                ...
                {activeMediaTab === 'attachments' && (
                  <div>
                    ...
                    {existingAttachments.map((att, index) => (
                      <div key={index} className="flex items-center justify-between text-sm bg-gray-50 p-3 rounded-xl mb-2">
          ...
          {/* Action Buttons */}
          <div className="sticky bottom-0 bg-white border-t border-gray-200 mt-8 pt-4 flex justify-end gap-3">
            <button
              type="button"
              onClick={onClose}
